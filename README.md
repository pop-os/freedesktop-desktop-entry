...
This crate provides a library for efficiently parsing [Desktop Entry](https://specifications.freedesktop.org/desktop-entry-spec/latest/index.html),  [Mime Apps](https://specifications.freedesktop.org/mime-apps/latest/index.html) and [Thumbnail](https://specifications.freedesktop.org/thumbnail/latest/index.html) files.
